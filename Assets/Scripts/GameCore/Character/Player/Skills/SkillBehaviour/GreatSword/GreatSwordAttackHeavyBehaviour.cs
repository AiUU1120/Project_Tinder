...
{
    public class GreatSwordAttackHeavyBehaviour : PlayerSkillBehaviourBase
    {
        [SerializeField]
        ...
        public override SkillBehaviourBase DeepCopy() => new GreatSwordAttackHeavyBehaviour { m_ComboCount = m_ComboCount };
