/*
 * @Author: AiUU
 * @Description: 大剑 GreatSword 轻攻击行为
 * @AkanyaTech.Tinder
 */
...
{
    public class GreatSwordAttackLightBehaviour : PlayerSkillBehaviourBase
    {
        [SerializeField]
        ...
        public override SkillBehaviourBase DeepCopy() => new GreatSwordAttackLightBehaviour { m_ComboCount = m_ComboCount };
