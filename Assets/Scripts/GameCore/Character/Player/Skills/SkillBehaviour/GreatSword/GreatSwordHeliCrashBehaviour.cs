...
{
    public class GreatSwordHeliCrashBehaviour : PlayerSkillBehaviourBase
    {
        public override SkillBehaviourBase DeepCopy() => new GreatSwordHeliCrashBehaviour();
