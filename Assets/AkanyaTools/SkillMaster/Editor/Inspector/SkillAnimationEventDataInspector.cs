/*
 * @Author: AiUU
 * @Description: SkillMaster 动画数据监视器绘制
...
{
    public sealed class SkillAnimationEventDataInspector : SkillEventDataInspectorBase<AnimationTrackItem, AnimationTrack>
    {
        ...
        public override void OnDraw()
        {
            ...
            var animationClipAssetField = new ObjectField("Animation Clip")
            {
                ...
                value = m_TrackItem.animationEvent.animationClip
            };
            ...
            {
                value = m_TrackItem.animationEvent.applyRootMotion
            };
            ...
            {
                value = m_TrackItem.animationEvent.durationFrame
            };
            ...
            {
                value = m_TrackItem.animationEvent.transitionTime
            };
            ...
            // 动画信息
            var clipFrameCount = (int) (m_TrackItem.animationEvent.animationClip.length * m_TrackItem.animationEvent.animationClip.frameRate);
            m_AnimationClipFrameLabel = new Label("Frame Count: " + clipFrameCount);
            m_Root.Add(m_AnimationClipFrameLabel);
            m_AnimationIsLoopLabel = new Label("Is Loop: " + m_TrackItem.animationEvent.animationClip.isLooping);
        ...
        private void OnAnimationClipAssetFieldValueChanged(ChangeEvent<UnityEngine.Object> evt)
        {
            ...
            m_TrackItem.animationEvent.animationClip = clip;
        ...
        {
            m_TrackItem.animationEvent.applyRootMotion = evt.newValue;
            SkillMasterEditorWindow.instance.SaveConfig();
            SkillMasterEditorWindow.instance.TickSkill();
        }
        ...
        private void OnAnimationDurationFieldFocusOut(FocusOutEvent evt)
        {
            ...
            // 安全校验
            if (m_Track.CheckFrame(m_ItemFrameIndex + m_AnimationDurationField.value, m_ItemFrameIndex, false))
            {
                m_TrackItem.animationEvent.durationFrame = m_AnimationDurationField.value;
                m_TrackItem?.CheckBoundaryOverflow();
                SkillMasterEditorWindow.instance.SaveConfig();
                m_TrackItem?.ForceRefreshView();
            }
            else
        ...
        private void OnAnimationTransitionFieldFocusOut(FocusOutEvent evt)
        {
            ...
            m_TrackItem.animationEvent.transitionTime = m_AnimationTransitionField.value;
            SkillMasterEditorWindow.instance.SaveConfig();
        }
        ...
        private void OnAnimationSetFrameBtnClick()
        {
            ...
            m_AnimationDurationField.value = SkillMasterEditorWindow.instance.curSelectedFrameIndex - m_TrackItem.frameIndex;
