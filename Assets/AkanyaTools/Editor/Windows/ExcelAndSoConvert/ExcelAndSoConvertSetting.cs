...
namespace JKFrame.Editor
{
    ...
    public class ExcelAndSoConvertSetting : ConfigBase
    {
        ...
        {
            [LabelText("一个Excel生成一个SO")]
            Excel2OneSO,

            [LabelText("一个Excel生成多个SO")]
            Excel2SOs,

            [LabelText("一个SO生成一个Excel")]
            OneSo2Excel,

            [LabelText("多个SO生成一个Excel")]
            SOs2Excel,
        }
        ...
        public int soFileNameUseFileIndex = 0;
        ...
        [TabGroup("批量转换")]
        [LabelText("转换前清空SO文件夹目录"), ShowIf("CheckDeleteFolder")]
