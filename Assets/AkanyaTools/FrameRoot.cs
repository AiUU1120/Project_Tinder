...
namespace AkanyaTools
{
    ...
    public class FrameRoot : MonoBehaviour
    {
        ...
        public static FrameToolsSetting toolsSetting
        {
            get => Instance.m_FrameToolsSetting;
        }

        // 框架层面的配置文件
        [SerializeField]
        FrameToolsSetting m_FrameToolsSetting;
        ...
        private void InitSystems()
        {
            ...
            MonoSystem.Init();
            AudioManager.Init();
            UISystem.UISystem.Init();
            SaveSystem.Init();
            LocalizationSystem.Init();
#if ENABLE_LOG
            JKLog.Init(m_FrameToolsSetting.logConfig);
#endif
        }
        ...
        public static void InitForEditor()
        {
            ...
            if (Instance == null)
            {
                ...
                Instance.m_FrameToolsSetting.InitOnEditor();
                //// 场景的所有窗口都进行一次Show
